...
jpackage --type app-image --name "VillageWaterManagement" --app-version 1.6.4 --input "%~dp0target" --main-jar "%JAR_NAME%" --main-class org.springframework.boot.loader.launch.JarLauncher --runtime-image "%~dp0target\custom-jre" --java-options "--enable-native-access=ALL-UNNAMED" --dest "%~dp0installer"
